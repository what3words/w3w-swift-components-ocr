...
public extension W3WAppEventName {
  ...
  static let ocrLiveScan: W3WAppEventName             = "ocr_live_scan"                // Pro users  Triggered when user clicks on Live Scan while it is unlocked on the OCR main screen.
  ...
  static let ocrLiveScanOn: W3WAppEventName         = "ocr_live_scan_on"            // Pro users  Triggered when user toggles off Live scan on the OCR main screen.
  static let ocrPhotoCapture: W3WAppEventName       = "ocr_photo_capture"          // All users  Triggered when user clicks on the captures photo button on the OCR main screen.
  static let ocrResultPhotoImport: W3WAppEventName  = "ocr_result_photo_import"   // Pro users  Triggered when a user views OCR results after importing a photo.
  static let ocrResultPhotoCapture: W3WAppEventName = "ocr_result_photo_capture" // All users  Triggered when a user views OCR results after capturing a photo.
  static let ocrResultLiveScan: W3WAppEventName     = "ocr_result_live_scan"    // Pro users  Triggered when a user views OCR results after live scan.
  static let ocrNoResultFound: W3WAppEventName     = "ocr_no_result_found"     // All users  Triggered when no OCR results were found, and the message i.e. “Sorry, we could not detect any what3words address in the photo.” is shown to the user.
  static let ocrTryAgain: W3WAppEventName         = "ocr_try_again"           // All users  Triggered when users clicks the 'Try again' button after no OCR results were found.
  static let ocrResultSelect: W3WAppEventName    = "ocr_result_select"       // Pro users  Triggered when user click 'Select' on the OCR Results screen.
